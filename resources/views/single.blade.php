                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="socials text-center">
                            ...
                            <div class="addthis_inline_share_toolbox_7p9l"></div>
                        </div>
                    ...
                    <div class="pagination-arrow">
                        ...
                        <a href="{{ route('post.single', ['slug' => $prev->slug]) }}" class="btn-next-wrap">
                            ...
                            <svg class="btn-next">
                                <use xlink:href="#arrow-right">{{ $prev->title }}</use>
                            </svg>
                        </a>
                        @endif

                            @if($next) {{-- if there is a next post than do that if not,  don't show next button---}}
